      ...
      >
        ...
        >
          <div className='w-full p-2 rounded-xl '>
            <H3 style={{ color: "black" }}>{getFeedback(totalScore)}</H3>
            <Plot
              data={[
                {
                  x: x_points,
              ...
              layout={{ width: 500, height: 500, title: 'Performance Review' }}
            />
        ...
        <div className='flex items-center justify-between px-12 py-6'>
          {over && <button className='bg-purple hover:bg-fuchsia-400 text-white font-medium py-2 px-4 rounded-lg my-2' onClick={startMovenet}>Start Level</button>}
          ...
          {recordedChunks.length > 0 && (
            <button className='bg-purple hover:bg-fuchsia-400 text-white font-medium py-2 px-4 rounded-lg my-2' onClick={handleDownload}>Download</button>
          )}
        </div>
        <div className='flex px-8 h-1/2 '>
          <div className='border-8 border-purple m-2  '>
            <ReactPlayer
              width="100%"
          ...
          <div className='border-8 border-purple m-2  'style={{ position: 'relative' }}>
            <Webcam
